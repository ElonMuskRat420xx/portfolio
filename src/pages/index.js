...
import AboutMeSection from "../components/Main/About/Hero";

export default function Connect() {
  return (
    <>
      <main className="font-primary hyphens-manual max-h-screen overflow-y-scroll overflow-x-hidden sm:ml-[10rem] ">
        <div className="mx-auto my-auto page print:max-w-letter print:mx-0 print:my-o md:max-w-letter p-2 sm:p-8 md:p-8 lg:mt-6 lg:mb-6 print:bg-white ">
          <AboutMeSection />
          <SkillsSection />
          <ExperienceSection />
          <EducationSection />
