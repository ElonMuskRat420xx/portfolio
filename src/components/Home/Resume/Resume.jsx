         ...
         <div className="break-inside-avoid">
           <section className="pb-2 border-b-2 break-inside-avoid">
             <ul className="list-inside pr-2 grid grid-cols-2">
               ...
               <li className="mt-2 leading-normal transition duration-100 ease-in text-gray-550 text-md hover:text-gray-700">
                 <span className="text-lg font-semibold text-gray-700 leading-snugish">Portfolio: </span>
             ...
             <ul className="mt-2.1 text-md text-gray-700 leading-normal">
               <li>
                 ...
                 <ul>
                   ...
                   <li className="    "> Tasked with construction of a large steel partition wall and sliding door to allow for separation within the workspaces. Recognized for fabrication competencies and ability to carry out complex tasks with minimal instruction.</li>
                 </ul>
               </li>
             </ul>
           </section>
         ...
         <div className="break-inside-avoid">
           ...
           <section className="pb-2 mt-2 mb-2 border-b-2 break-inside-avoid">
             <header>
               ...
               <p className="leading-normal text-md text-gray-550"> 2010 – 2015 </p>
             </header>
           </section> {/*-----------------------------------------------------------------------------------*/} <section className="pb-2 mt-2 mb-2 border-b-2 break-inside-avoid">
             <header>
               ...
               <p className="leading-normal text-md text-gray-550">
                 <span className="font-semibold text-gray-700 text-md leading-snugish" /> HND Mechancial Engineering 2015 – 2017
               </p>
             </header>
           </section> {/*-----------------------------------------------------------------------------------*/} <section className="pb-2 mt-2 mb-2 border-b-2 break-inside-avoid">
             <header>
               ...
               <p className="leading-normal text-md text-gray-550">
                 <span className="font-semibold text-gray-700 text-md leading-snugish" /> Apprenticeship Light Motor Vehicle Technician L3 2014 – 2017
               </p>
             </header>
           </section> {/*-----------------------------------------------------------------------------------*/} <section className="mt-2 break-inside-avoid">
             <header>
               <h3 className="flex-grow text-lg font-semibold text-gray-700 leading-snugish"> University Of Aberdeen </h3>
             </header>
             <p className="leading-normal text-md text-gray-550">
               <span className="font-semibold text-gray-700 text-md leading-snugish" /> B-Eng Mechancial Engineering 2017 | 2021
             </p>
           </section>
         </div>
       </section> {/*-----------------------------------------------------------------------------------*/} {/*Projects---------------------------------------------------------------------------*/} {/*-----------------------------------------------------------------------------------*/} {/* <section class="pb-4 mt-4 border-b-2 first:mt-0">
         <div class="break-inside-avoid">
           <h2 class="mb-2 text-lg font-bold tracking-widest text-gray-700 print:font-normal"> PROJECTS </h2>
           <section class="pb-2 mb-2 break-inside-avoid">
             <header>
               <h3 class="text-lg font-semibold text-gray-700 leading-snugish">
                 <a href="https://glk-nelson.xyz" class="group"> Portfolio Website <span class="inline-block mr-3 font-normal transition duration-100 ease-in text-gray-550 print:text-black group-hover:text-gray-700"> ↗ </span>
                 </a>
                 <span class="inline-block font-normal transition duration-100 ease-in text-gray-550 print:text-black group-hover:text-gray-700">
                   <a href="https://glk-nelson.xyz">
                     <i class="fab fa-github"></i>
                   </a>
                 </span>
               </h3>
               <p class="leading-normal text-md text-gray-550"> Since 2022 | JSX, React, Next.js, ThreeJS, Tailwind, MDX </p>
             </header>
             <p class="mt-2.1 text-md text-gray-700 leading-normal"> A unique and streamlined personal portfolio site built using Next.js. Interface is clean and features graphics designed personally for use within the site. </p>
           </section>
         </div>
       </section> */} {/*Skills-----------------------------------------------------------------------------*/} {/*-----------------------------------------------------------------------------------*/} <section className="pb-2 mt-2 first:mt-0">
         <div className="break-inside-avoid">
